...
<body>
    ...
    width: fill-available;">
            <h3><a href="../manager/webmanager.php"><i class="bi bi-arrow-left-circle"></i></a><?php echo $inttaxes;?></h3>
            <table class="table table-striped table-hover table-borderless table-primary align-middle">
                <thead>
                    <tr style="position: sticky; top:0;">
                        <th><?php echo $inttaxid;?></th>
                        <th><?php echo $taxname;?></th>
                        <th><?php echo $taxpercent;?></th>
                    </tr>
                </thead>
                <tbody class="table-group-divider">
                    <?php
                                ...
                                echo("<td colspan=3>".$notaxtytes."</td></tr>");
                                    ...
                                    $rowtaxes = [];
                                    if ($resulttaxes->num_rows > 0){$rowtaxes = $resulttaxes->fetch_all(MYSQLI_ASSOC);};
                                };
                                if(!empty($rowtaxes)){
            ...
            ?>
                    <tr>
                        ...
                        <td><?php echo $rowstaxes['ivaid']; ?></td>
                        <td><?php echo $rowstaxes['ivatype']; ?></td>
                        <td><?php echo ($rowstaxes['ivaperc']." (%)"); ?></td>
                    </tr>
                    <?php };} ?>
                    </tr>
                </tbody>
    ...
    <div class="tab-content" id="nav-tabContent">
        <div class="bg-white tab-pane fade show" id="nav-addtax" role="tabpanel"
            aria-labelledby="nav-addtax-tab">
