...
?>
    ...
    width: fill-available;">
                <h3><a href='../manager/webmanager.php'><i class='bi bi-arrow-left-circle'></i></a><?php echo $vouchers;
?></h3>
                <table class='table table-striped table-hover table-borderless table-primary align-middle'>
                    <thead>
                        <tr style='position: sticky; top:0;'>
                            <th><?php echo $intvouchid;
?></th>
                            <th><?php echo $vouchcode;
?></th>
                            <th><?php echo $vouchdisc;
?></th>
                            <th><?php echo $vouchdateadded;
?></th>
                            <th><?php echo $vouchfinaldate;
?></th>
                        </tr>
                    </thead>
    ...
    foreach ( $rowvouchers as $rowsvouchers )
 {
        ...
        ?>
                        <tr>
                            ...
                            <td><?php echo $rowsvouchers[ 'vouchid' ];
        ?></td>
                            <td><?php echo $rowsvouchers[ 'voucher' ];
        ?></td>
                            <td><?php echo ( $rowsvouchers[ 'vouchpercent' ].$percent );
        ?></td>
                            <td><?php echo $rowsvouchers[ 'creationdate' ];
        ?></td>
                            <td><?php echo $rowsvouchers[ 'finaldate' ];
        ?></td>
                        </tr>
                        <?php }
        ;
    ...
    <nav class="nav nav-pills" id="nav-tab" role="tablist">
        <a class="nav-link" id="nav-addvoucher-tab" data-bs-toggle="tab" href="#nav-addvoucher" role="tab"
            aria-controls="nav-addvoucher" aria-selected="true">'.$addany.' '.$vouchers.'</a>
        <a class="nav-link" id="nav-deletevoucher-tab" data-bs-toggle="tab" href="#nav-deletevoucher" role="tab"
            aria-controls="nav-deletevoucher" aria-selected="false">'.$delany.' '.$vouchers.'</a>
        <a class="nav-link" id="nav-editvoucher-tab" data-bs-toggle="tab" href="#nav-editvoucher" role="tab"
            aria-controls="nav-editvoucher" aria-selected="false">'.$editany.' '.$vouchers.'</a>
    </nav>' );
    } else {
