...
<div class="p-0 mb-4 bg-light rounded-3">
    ...
    <h3><a href="../manager/webmanager.php"><i class="bi bi-arrow-left-circle"></i></a><?php echo $invoicesopts;?></h3>
    <div class="table-responsive bg-light" style="height:369px;overflow-y:scroll;">
            ...
            <?php };} ?>  
                ...
                <caption class="sticky-bottom"><?php echo("(".mysqli_fetch_array(mysqli_query($con,"SELECT count(*) from invoices"))[0].$invoices2show);?></caption>
  ...
  <a class="nav-link" id="nav-searchinvoicebydiscountvoucher-tab" data-bs-toggle="tab" href="#nav-searchinvoicebydiscountvoucher" role="tab" aria-controls="nav-searchinvoicebydiscountvoucher" aria-selected="false">'.$invoicesearch." ".$voucherstring.'</a>
</nav>');}else{
