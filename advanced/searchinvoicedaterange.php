...
if ( mysqli_num_rows( mysqli_query( $con, 'SELECT * FROM invoices' ) ) === 0 ) {
    ...
    <div class="col-2">
    <label for="mindaterange" class="form-label">'.$mindaterange.'</label>
  <input type="date" class="form-control" name="mindaterange" id="mindaterange" aria-describedby="helpId" placeholder="'.$invoiceid.'" required>
  </div>
  <div class="col-2">
        <label for="maxdaterange" class="form-label">'.$maxdaterange.'</label>
      <input type="date" class="form-control" name="maxdaterange" id="maxdaterange" aria-describedby="helpId" placeholder="'.$invoiceid.'" required>
      </div>
      </div>
