...
<div class="p-0 mb-4 bg-light rounded-3">
    ...
    <h3><a href="invoicesearch.php"><i class="bi bi-arrow-left-circle"></i></a><?php echo $invoicesopts;?></h3>
    <div class="table-responsive bg-light" style="height:369px;overflow-y:scroll;">
            ...
            <?php };} ?>  
                ...
                <caption class="sticky-bottom"><?php echo("(".mysqli_num_rows(mysqli_query($con,$searchquery)).$invoices2show);?></caption>
